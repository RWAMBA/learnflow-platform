...
| _(none — new)_                                                                                                                                                              | **NEW**                | `curriculum_versions`                                                                                                                             |
| _(none — new)_                                                                                                                                                              | **NEW**                | `education_stages`                                                                                                                                |
...
| _(none — new)_                                                                                                                                                              | **NEW**                | `curriculum_nodes` (self-referencing)                                                                                                             |
...
| _(none — new)_                                                                                                                                                              | **NEW**                | `learning_resources`, mirroring Lesson's ownership pattern                                                                                        |
